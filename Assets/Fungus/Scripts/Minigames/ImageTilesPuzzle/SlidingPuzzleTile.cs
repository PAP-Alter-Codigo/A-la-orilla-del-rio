...
public class SlidingPuzzleTile : MonoBehaviour
{
    ...
    {
        if(!Input.GetMouseButton(0) || board.isTileMoving) return;
        ...
        // Si la pieza no puede moverse, agitarla y salir
    ...
    public bool IsOnTargetPos() => transform.localPosition.Equals(targetPos);
}
